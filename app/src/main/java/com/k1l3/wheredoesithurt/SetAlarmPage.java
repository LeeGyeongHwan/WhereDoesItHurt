...
public class SetAlarmPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        final ArrayList<TextView> arrayText = new ArrayList<>();
        final ArrayList<TimePicker> arrayPicker = new ArrayList<>();
        ArrayList<ImageView> arrayImg = new ArrayList<>();
        ArrayList<LinearLayout> arrayLinear = new ArrayList<>();
        ArrayList<Button> arrayBtn = new ArrayList<>();
    ...
    public void setAgain(int what,int year, int month, int day){
        ...
        switch (what){
            case 1:from_dateText.setText(date);break;
            case 2:to_dateText.setText(date);break;
        }
    }
}
